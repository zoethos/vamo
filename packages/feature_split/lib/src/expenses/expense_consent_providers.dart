...
final tripShareConsentFlagsProvider =
    Provider.family<List<({String userId, String label, String expenseId})>, String>(
  (ref, tripId) {
    ...
    final members = ref.watch(tripMembersForExpenseProvider(tripId)).valueOrNull ?? [];
      ...
      for (final share in shares)
        if (committedIds.contains(share.expenseId) &&
          ...
          (
            ...
            label: shareConsentDisplayLabel(
