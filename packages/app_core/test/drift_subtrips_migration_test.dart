...
void main() {
  test('schema v25 includes subtrip columns and tables', () async {
  ...
  test('v24 to v25 migration adds subtrip mirrors', () async {
    ...
    await db.migration.onUpgrade(migrator, 24, 25);
