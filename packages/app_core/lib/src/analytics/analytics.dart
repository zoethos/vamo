...
enum VamoEvent {
  ...
  captureActionStarted('capture_action_started'),
  captureActionCompleted('capture_action_completed'),
  captureActionAbandoned('capture_action_abandoned'),
  ...
  shareOpenAppTapped('share_open_app_tapped'),
  ...
  static const productSignals = [
    ...
    captureActionCompleted,
    captureActionAbandoned,
    plusInterestTapped,
    recapInterestTapped,
    mapInterestTapped,
    notifyMeOptedIn,
