...
const defaultRules = [
  ...
  GuardRule(
    name: 'app_core domain sub-barrel',
    paths: ['packages/app_core/lib/domain.dart'],
    forbiddenImports: [
      ForbiddenImport('infra.dart',
          reason: 'domain.dart must not import or export infra.dart'),
      ForbiddenImport('src/db/',
          reason: 'domain.dart must not export database internals'),
      ForbiddenImport('src/supabase/',
          reason: 'domain.dart must not export Supabase internals'),
      ForbiddenImport('src/storage/storage_attachment_load.dart',
          reason: 'domain.dart must not export storage loading'),
      ForbiddenImport('src/auth/auth_repository.dart',
          reason: 'domain.dart must not export auth repositories'),
      ForbiddenImport('src/push/push_registrar.dart',
          reason: 'domain.dart must not export platform push registration'),
      ForbiddenImport('src/env/env.dart',
          reason: 'domain.dart must not export environment access'),
    ],
  ),
];
