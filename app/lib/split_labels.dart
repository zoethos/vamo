...
class SplitLabels {
  ...
  static BalancesTabLabels balances(AppLocalizations l10n) => BalancesTabLabels(
        ...
        legendOwedToYou: l10n.balancesLegendOwedToYou,
        legendYouOwe: l10n.balancesLegendYouOwe,
        statusAwaiting: l10n.balancesStatusAwaiting,
        statusMarkedPaid: l10n.balancesStatusMarkedPaid,
  ...
  static CreateTripLabels createTrip(AppLocalizations l10n) => CreateTripLabels(
        ...
        datePickerSkip: l10n.datePickerSkip,
        datePickerSelect: l10n.datePickerSelect,
        advanced: _advancedTravel(l10n),
      );

  static AdvancedTravelLabels _advancedTravel(AppLocalizations l10n) =>
      AdvancedTravelLabels(
        toggleTitle: l10n.travelToggleTitle,
        toggleBadge: l10n.travelToggleBadge,
        toggleSubtitle: l10n.travelToggleSubtitle,
        legsSectionTitle: l10n.travelLegsSectionTitle,
        legsInOrder: l10n.travelLegsInOrder,
        addLeg: l10n.travelAddLeg,
        noLegs: l10n.travelNoLegs,
        draftWithAi: l10n.travelDraftWithAi,
        draftWithAiBadge: l10n.travelDraftWithAiBadge,
        draftComingSoon: l10n.travelDraftComingSoon,
        planItMyself: l10n.travelPlanItMyself,
        aiFootnote: l10n.travelAiFootnote,
        legEditorTitle: l10n.travelLegEditorTitle,
        removeLeg: l10n.travelRemoveLeg,
        modeSectionTitle: l10n.travelModeSectionTitle,
        windowSectionTitle: l10n.travelWindowSectionTitle,
        windowAnyTime: l10n.travelWindowAnyTime,
        windowOptionalHint: l10n.travelWindowOptionalHint,
        reachSectionTitle: l10n.travelReachSectionTitle,
        reachDistance: l10n.travelReachDistance,
        reachTime: l10n.travelReachTime,
        reachNoLimit: l10n.travelReachNoLimit,
        reachDistanceCaption: l10n.travelReachDistanceCaption,
        reachTimeCaption: l10n.travelReachTimeCaption,
        reachHoursUnit: l10n.travelReachHoursUnit,
        unitsFootnote: l10n.travelUnitsFootnote,
        saveLeg: l10n.travelSaveLeg,
        modeCar: l10n.travelModeCar,
        modeMotorbike: l10n.travelModeMotorbike,
        modeBike: l10n.travelModeBike,
  ...
  static AddExpenseScreenLabels addExpense(AppLocalizations l10n) =>
      AddExpenseScreenLabels(
        ...
        youPaid: l10n.addExpenseYouPaid,
        paidBy: l10n.addExpensePaidBy,
        splitSection: l10n.addExpenseSplitSection,
        splitEqual: l10n.addExpenseSplitEqual,
        splitCustom: l10n.addExpenseSplitCustom,
        customSplitComingSoon: l10n.addExpenseCustomSplitComingSoon,
        splitEach: l10n.addExpenseSplitEach,
        attachReceipt: l10n.addExpenseAttachReceipt,
        addPlace: l10n.addExpenseAddPlace,
        addNote: l10n.addExpenseAddNote,
        descriptionHint: l10n.addExpenseDescriptionHint,
        currencySheetTitle: l10n.addExpenseCurrencySheetTitle,
        categorySheetTitle: l10n.addExpenseCategorySheetTitle,
        payerSheetTitle: l10n.addExpensePayerSheetTitle,
        done: l10n.addExpenseDone,
        descriptionRequired: l10n.addExpenseDescriptionRequired,
        readingReceipt: l10n.addExpenseReadingReceipt,
        receiptAttached: l10n.addExpenseReceiptAttached,
        removeReceipt: l10n.addExpenseRemoveReceipt,
      );
}
