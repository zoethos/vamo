...
async function handleHostedSchedulerRequest(request: NextRequest) {
  ...
  const schedulerEnv: HostedAutonomySchedulerEnv = {
    ...
    CONFLUENDO_SNAPSHOT_ARTIFACT_SUPABASE_PROJECT_REF:
      process.env.CONFLUENDO_SNAPSHOT_ARTIFACT_SUPABASE_PROJECT_REF,
    CONFLUENDO_SNAPSHOT_ARTIFACT_SUPABASE_BUCKET:
      process.env.CONFLUENDO_SNAPSHOT_ARTIFACT_SUPABASE_BUCKET,
    CONFLUENDO_SNAPSHOT_ARTIFACT_SUPABASE_REGION:
      process.env.CONFLUENDO_SNAPSHOT_ARTIFACT_SUPABASE_REGION,
    CONFLUENDO_SNAPSHOT_ARTIFACT_SUPABASE_PREFIX:
      process.env.CONFLUENDO_SNAPSHOT_ARTIFACT_SUPABASE_PREFIX,
    CONFLUENDO_SNAPSHOT_ARTIFACT_SUPABASE_ACCESS_KEY_ID:
      process.env.CONFLUENDO_SNAPSHOT_ARTIFACT_SUPABASE_ACCESS_KEY_ID,
    CONFLUENDO_SNAPSHOT_ARTIFACT_SUPABASE_SECRET_ACCESS_KEY:
      process.env.CONFLUENDO_SNAPSHOT_ARTIFACT_SUPABASE_SECRET_ACCESS_KEY
  };
